...
export default function About() {
    return (
        <main className="h-full w-full flex flex-col items-center p-6 bg-slate-50 dark:bg-gray-900">
            {/* About Section */}
            <h1 className="text-2xl md:text-3xl font-bold text-center text-gray-800 dark:text-gray-200 mt-3 mb-6">
                Get to know me more
            </h1>
            <div className="mb-6 flex flex-col sm:flex-row max-w-4xl w-full items-center gap-8 border border-gray-400 dark:border-gray-600 rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="max-w-5xl w-full">
                <h1 className="text-lg md:text-xl font-bold text-center text-gray-800 dark:text-gray-200 mb-6">
                    What I'm capable of doing
                </h1>
                <div className="flex flex-col sm:flex-row justify-between gap-4 sm:gap-8">
                    {/* Web Development */}
                    <div className="p-5 sm:p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-400 dark:border-gray-600 hover:border-indigo-700 hover:dark:border-amber-400 duration-300 w-full sm:w-1/3">
